<template>
  <div class="header">
    ...
    <!-- 弹窗 -->
    <div v-show="detailShow" class="detail" transition="fad">
      <div class="detail-wrapper clearfix">
        <div class="detail-main">
          ...
          <title-line :name="supportsTitle"></title-line>
          ...
          <title-line :name="sellerNotice"></title-line>
          <div class="bulletin">
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .header
    ...
    .detail
      ...
      overflow auto
      transition all 0.5s
      backdrop-filter blur(10px) // 在ios手机上才可以实现背景模糊
      &.fad-transition
        opacity 1
